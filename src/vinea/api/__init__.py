...
THE RULE (S5.4), stated once here and enforced everywhere below: the API does not
...
job (phase 8), reached through the queue. The API's latency is a database write, not an
LLM call.
"""
