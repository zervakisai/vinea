...
The scoring half of observability. The insight that shapes everything here: for the legs
...
The oracle plays two roles that must NOT become one code path -- the circularity
trap: inline it's the output_validator that forces a retry; here, async,
